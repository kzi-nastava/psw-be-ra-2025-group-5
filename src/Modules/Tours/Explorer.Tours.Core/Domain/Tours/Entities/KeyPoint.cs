...
public class KeyPoint : Entity
{
    ...
    internal KeyPoint(string name, string description, Location location, string? imagePath, string? secret, int position)
    {
    ...
    public void Update(string name, string description, string? imagePath, string? secret, Location location)
    {
        if (string.IsNullOrWhiteSpace(name))
            throw new ArgumentException("Key point name is required.", nameof(name));
