...
INSERT INTO tours."Tours"(
	...
	INSERT INTO tours."Tours"(
	"Id", "AuthorId", "Name", "Description", "Difficulty", "Tags", "Price", "Status", "TourLength")
	VALUES (-4, -12, 'BG tour', 'Some desc of BG', 1, ARRAY['Food','History'], 0, 0, 0);
	INSERT INTO tours."Tours"(
	"Id", "AuthorId", "Name", "Description", "Difficulty", "Tags", "Price", "Status", "TourLength")
	VALUES (-5, -12, 'NS tour', 'Some desc of NS', 1, ARRAY['Food'], 0, 1, 0);
	INSERT INTO tours."Tours"(
	"Id", "AuthorId", "Name", "Description", "Difficulty", "Tags", "Price", "Status", "TourLength")
	VALUES (-6, -11, 'BCN tour', 'Some desc of BCN', 1, ARRAY['History'], 0, 2, 0);