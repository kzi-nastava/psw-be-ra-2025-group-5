INSERT INTO stakeholders."TourProblems"(
	...
	VALUES (-11, -1, -21, 0, 2, 'Problem sa autobusom', '2025-10-25T10:00:00Z', '2025-10-25T10:05:00Z', ARRAY[]::bigint[] , true, null);
INSERT INTO stakeholders."TourProblems"(
    "Id", "TourId", "ReporterId", "Category", "Priority", "Description", "OccurredAt", "CreatedAt", "Comments", "IsResolved", "Deadline")
	VALUES (-22, -2, -22, 0, 2, 'Nismo dobili adekvatne informacije gde se grupa sastaje', NOW() - interval '20 days', NOW() - interval '20 days', ARRAY[]::bigint[], false, NOW() - interval '10 days');
