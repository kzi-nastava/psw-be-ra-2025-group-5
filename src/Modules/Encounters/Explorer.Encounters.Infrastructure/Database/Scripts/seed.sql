...
INSERT INTO encounters."Challenges"(
    "Id", "Name", "Description", "Latitude", "Longitude", "ExperiencePoints", "Status", "Type", "CreatedByTouristId", "RequiredParticipants", "RadiusInMeters", "ImageUrl")
VALUES (2, 'Susret sa lokalcima', 'Upoznajte tri lokalna stanovnika i saznajte njihove price.', 44.815556, 20.460833, 200, 1, 0, null, 2, 50, null);

INSERT INTO encounters."Challenges"(
    "Id", "Name", "Description", "Latitude", "Longitude", "ExperiencePoints", "Status", "Type", "CreatedByTouristId", "RequiredParticipants", "RadiusInMeters", "ImageUrl")
VALUES (3, 'Skrivena lokacija', 'Pronadjite skrivenu lokaciju u starom gradu i otkrijte tajnu.', 44.818611, 20.457222, 200, 0, 2, null, null, null, null);

INSERT INTO encounters."Challenges"(
    "Id", "Name", "Description", "Latitude", "Longitude", "ExperiencePoints", "Status", "Type", "CreatedByTouristId", "RequiredParticipants", "RadiusInMeters", "ImageUrl")
VALUES (4, 'Istorijski spomenik', 'Posetite istorijski spomenik i naucite njegovu pricu.', 44.821111, 20.462778, 300, 2, 1, null, null, null, null);
